                    ...
                    MediaManager.get().upload(data.getData())
                            ...
                            .callback(new UploadCallback() {
                                ...
                                public void onSuccess(String requestId, Map resultData) {
                                    ...
                                    Map<String, String> contextResponseData  = (HashMap)resultData.get("context");
                                    Map.Entry<String,String> Mapvalue = contextResponseData.entrySet().iterator().next();

                                    //get the map key
                                    String key  = Mapvalue.getKey(); // returns "custom"

                                    //get the map value i.e title and price
//                                    String value = Mapvalue.getValue(); //throws java.lang.ClassCastException: java.util.HashMap cannot be cast to java.lang.String

                                    //returnedTitle = value.get("title");
                                    //returnedPrice = value.get("price");

                                    ListClass Lclass = new ListClass(getUrlForMaxWidth(resultData
                                            .get("public_id").toString()),
                                            returnedTitle, returnedPrice);
